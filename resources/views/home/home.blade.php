    ...
    <div class="w-full h-full   rounded-xl">
        ...
        <div class="w-full  flex flex-row-reverse justify-around">
            ...
            <div class="bg-forth-color flex flex-col items-center mb-8 h-[38vh] w-[20vw] rounded-xl">
                <img src="https://www.pngall.com/wp-content/uploads/5/User-Profile-PNG-Clipart.png" class="w-[8vw] py-2"
                    alt="">
            ...
            <div class="border-b bg-secondary-color border-gray-400 flex flex-col rounded-xl w-[30vw] h-[30vh]">
                ...
                <p class="text-2xl px-4 text-white">$ <span class="text-5xl barlow-thin">{{ $user->cards[0]->balance }}</span> </p>
        ...
        <div class="w-[50vw] ml-20 mt-4">
            <article class="rounded-xl group duration-[.6s] [transform-style: preserve-3d]"
                style="transition: 0.6s;transform-style: preserve-3d;">

                <figure
                    class="relative w-96 h-60  font-mono text-white overflow-hidden cursor-pointer group:hover:rotate-y-[180deg] transition-all duration-500">
                    <!-- Front content -->
                    <section
                        class="absolute top-0 left-0 w-full h-full flex flex-col justify-center gap-6 p-6 bg-gradient-to-tr from-bg-yellow-500 to-gray-700 transition-all duration-100 delay-200 z-20 rounded-full "
                        ...
                        <div class="">
                            ...
                            <input type="text" id="" value="{{ $user->cards[0]->card_number }}" readonly
                        ...
                        <div class="w-full flex flex-row justify-between">
                            ...
                            <div class="w-1/4 flex flex-col">
                                ...
                                <input type="text" id="" value="12/34" readonly
                                    class="outline-none bg-transparent">
                            </div>
                ...
                <!-- Front content -->
                <div class="absolute top-0 left-0 w-[25vw] h-full flex flex-col justify-center gap-6 p-6 bg-gradient-to-tr from-gray-900 to-gray-700 transition-all duration-100 delay-200 z-20"
                    style="transform: rotateY(0deg);">
                    ...
                    <div class="w-full flex flex-row justify-between">
                        ...
                        <div class="w-1/4 flex flex-col px-1">
                            ...
                            <input type="text" id="" value="{{ $user->cards[0]->expiration_date }}" readonly
                                class="outline-none bg-transparent text-white rounded-xl">
                        </div>
